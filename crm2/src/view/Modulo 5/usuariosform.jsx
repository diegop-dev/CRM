...
import {
  ...
  TouchableOpacity,
  ActivityIndicator,
  ScrollView // Nota: Si el contenido crece, ScrollView es útil
} from "react-native";
...
const FormInput = ({ label, value, onChangeText, placeholder, secureTextEntry, editable = true }) => (
  <View style={styles.inputContainer}>
    ...
    <TextInput
      style={[
          styles.textInput, 
          !editable && styles.disabledInput // Estilo visual para campos bloqueados
      ]}
      value={value}
...
const styles = StyleSheet.create({
  ...
  helperText: { fontSize: 14, color: "#ddd", marginBottom: 10, fontStyle: "italic" },
