...
export default function AgregarClienteView({ navigation }) {
  ...
  // --- 2. Obtenemos los nuevos props del modal ---
  const { cliente, onChange, onGuardar, modalInfo, closeModal } = useAgregarClienteLogic();
...
            onChange={onChange} 
            onGuardar={onGuardar} 
            onRegresar={() => navigation.goBack()} // (Este ya estaba bien)
          />
        </View>
      </ScrollView>
