  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {/* --- ENCABEZADO (Estilo Base de Consultar + Botón Atrás) --- */}
        ...
        {/* ================================================= */}
        {/* VISTA 1: BÚSQUEDA (Idéntico a Consultar)          */}
        {/* ================================================= */}
        {!clienteSeleccionado && (
          <>
            ...
            {/* Lista de Resultados (Estilo Idéntico a Consultar) */}
            {clientes.length > 0 && (
        ...
        {/* ================================================= */}
        {/* VISTA 2: FORMULARIO (Contenedor Idéntico)         */}
        {/* ================================================= */}
        {clienteSeleccionado && (
          <View style={styles.formContainer}>
            
            {/* Botón Cancelar (Exclusivo de lógica Editar) */}
            {!clienteDesdeConsulta && (
              <TouchableOpacity onPress={deseleccionarCliente} style={styles.cancelButton}>
                <Text style={styles.cancelButtonText}>Cancelar / Buscar otro</Text>
              </TouchableOpacity>
            )}
...
// --- ESTILOS (Sincronizados con ConsultarClienteView) ---
const styles = StyleSheet.create({
  ...
  // Estilos extras para botones específicos de Editar (Atrás y Cancelar)
  backButton: { marginRight: 10, padding: 5 },
  backButtonText: { color: "#fff", fontSize: 24, fontWeight: "bold" },
  cancelButton: { alignSelf: "flex-end", padding: 5, marginBottom: 10 },
  cancelButtonText: { color: "#d92a1c", fontWeight: "600" },
  ...
  limpiarButton: { backgroundColor: "#E74C3C" }, // Se mantiene por consistencia de diseño

  // Lista (Idéntica a Consultar)
  ...
  // Formulario (Idéntico a Consultar)
  formContainer: {
