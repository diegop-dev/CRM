...
export default function MenuGestionDeProyectosView() {
  ...
  // --- FUNCIÓN: Inicia el proceso de salida ---
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#2b3042" }}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          {/* --- BOTÓN DE RETROCEDER (Estilo "Cerrar Sesión") --- */}
          <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  // --- ESTILO ACTUALIZADO: Igual que el botón de cerrar sesión ---
  backButtonHeader: {
    marginLeft: 'auto', 
    backgroundColor: "#77a7ab", // Color sólido Teal
    borderRadius: 25,           // Bordes redondeados
    paddingVertical: 8,
    paddingHorizontal: 15,
    // Eliminamos el borde transparente anterior para que sea sólido
    elevation: 2,               // Sutil sombra en Android
    shadowColor: "#000",        // Sutil sombra en iOS/Web
