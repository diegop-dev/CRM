...
export default function MenuGestionDeProyectosView({ navigation }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#2b3042" }}>
      ...
      >
        {/* Encabezado (AHORA FUERA del mainContentArea) */}
        ...
        {/* Contenedor principal (AHORA SÓLO PARA LA GRID) */}
...
const styles = StyleSheet.create({
  ...
  grid: {
    ...
    marginTop: 30, // Espacio después del header
  },
  button: {
