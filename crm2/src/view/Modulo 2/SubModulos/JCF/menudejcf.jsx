...
import { useMenuLogic } from "../../../../controller/Modulo 2/SubModulos/JCF/menudejcf";

// Añadimos { navigation } para poder regresar
export default function MenuDeJCFView({ navigation }) {
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#2b3042" }}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          />
          <Text style={styles.headerTitle}>JCF</Text>
        </View>
