...
export default function AgregarEmpleadoView() {
  ...
  // Extraemos también los estados del modal de feedback del hook
  const { 
    empleado, 
    onChange, 
    onGuardar, 
  ...
  const handleNavModalConfirm = () => {
    if (navModalStep === 1) {
      ...
      // Ajustamos la navegación para volver al Menú Principal como indicaba tu código original
