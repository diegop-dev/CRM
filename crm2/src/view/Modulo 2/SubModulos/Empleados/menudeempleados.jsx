...
import { useMenuLogic } from "../../../../controller/Modulo 2/SubModulos/Empleados/menudeempleados";

export default function MenuDeEmpleadosView() {
  ...
  const handleLogoPress = () => {
    Alert.alert(
      ...
      "¿Desea salir del módulo de Empleados y volver al menú principal?",
      [
