        ...
        <View style={styles.alertModalContainer}>
          {modalStep === 1 ? (
            <>
              ...
              <Text style={styles.modalMessage}>¿Desea editar este producto?</Text>
              <View style={styles.modalButtonContainer}>
                <TouchableOpacity
            ...
            <>
              ...
              <Text style={styles.modalMessage}>¿Desea ser dirigido al área segura para editar producto?</Text>
              <View style={styles.modalButtonContainer}>
                <TouchableOpacity
                  style={[styles.modalButton, styles.modalButtonCancel]}
                  onPress={handleModalCancel}
