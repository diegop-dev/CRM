...
export default function AgregarProductoView({ navigation }) {

  const { producto, empleadosList, onChange, onGuardar, modalInfo, closeModal } = useAgregarProductoLogic();
