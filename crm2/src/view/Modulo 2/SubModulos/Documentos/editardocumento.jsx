...
export default function EditarDocumentoView() {
  ...
  // CAMBIO: Ya no verificamos !documentoSeleccionado aquí, para que la barra se quede visible.
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView nestedScrollEnabled contentContainerStyle={styles.scrollContainer}>
        ...
        {/* CAMBIO 1: ÁREA DE BÚSQUEDA (Siempre visible si no venimos de consulta) */}
        {showSearchArea && (
          <>
