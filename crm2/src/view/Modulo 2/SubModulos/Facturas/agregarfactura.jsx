      ...
      >
        ...
        <View style={styles.mainContentContainer}>
          <FacturaFormView
            ...
            // Eliminamos onRegresar del prop porque ya está en el header, 
            // o lo dejamos vacío si el componente lo exige.
            onRegresar={() => {}} 
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalMessage}>
              {navModalStep === 1 
                ? "¿Desea salir de Agregar Factura y volver al menú principal?" 
