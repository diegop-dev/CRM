...
const poolPromise = require("../db"); // Asumo que tu conexión a DB está aquí
...
async function editarProyecto(req, res) {
  const { id } = req.params; // El ID del proyecto viene de la URL
  const {
    nombreProyecto,
    tipoProyecto,
    fechaInicio,
...
// ================================
// OBTENER PROYECTOS RECIENTES (NUEVO)
// ================================
...
module.exports = {
  ...
  buscarProyecto,
  editarProyecto,
  obtenerProyectosRecientes, // <-- AÑADIDO
};